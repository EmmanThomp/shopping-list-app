...
class _HomeState extends State<Home> {
  ...
  Future<List<GroceryItem>> _loadItems() async {
    final url = Uri.https('shopping-list-7ec0f-default-rtdb.firebaseio.com',
        'shopping-list.json');
    //try {
...
//         setState(() {
//           _error = '''
// Something has gone terribly wrong. Please, please try again later.
...
//       ''';
  ...
  void removeItem(GroceryItem item) async {
    ...
    //checking if the communication with firebase went through if not we add back
    if (response.statusCode >= 400) {
      //Optional: show error meesage
      setState(() {
